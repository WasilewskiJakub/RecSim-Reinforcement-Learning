...
class MusicDocument(IEDocument):
    ...
    def __init__(self, doc_id, cluster_id, quality, discovery_potential, virality_factor,
        ...
        Args:
            ...
            tempo (float): Tempo of the music in beats per minute (e.g., 40-200).
    ...
    def observation_space(cls):
        base_space = IEDocument.observation_space()
        ...
        combined_space = spaces.Dict({
            ...
            ,'mood_intensity': spaces.Box(low=0.0, high=1.0, shape=tuple(), dtype=np.float32)
...
class MusicDocumentSampler(IETopicDocumentSampler):
    ...
    def sample_document(self):
        ...
        doc_features['mood_intensity'] = self._rng.uniform(0.0, 1.0)
        doc_features['production_value'] = self._rng.uniform(0.0, 1.0)
