...
class QLearningAgent(AbstractEpisodicRecommenderAgent):
    ...
    def __init__(self, observation_space, action_space, learning_rate=0.1, discount_factor=0.8, exploration_rate=0.4):
        ...
        self.production_bins = np.linspace(0, 1, 5)
        self.quality_bins = np.linspace(0, 1, 5)

        # Test 2:
        self.genre_bins = np.linspace(0, 1, 9)
        self.production_bins = np.linspace(0, 1, 6)
        self.quality_bins = np.linspace(0, 1, 7)
